...
![Version](https://img.shields.io/badge/versiyon-15.0-ff7597?style=for-the-badge)
...
*   **Kuvaterner Paleolimnoloji ve İklim Döngüleri Simülatörü:** Dünya'nın Milankovitch yörünge döngüleri (Eksantriklik, Eksen Eğikliği, Yalpalama) altındaki güneş insolasyon değişimlerini ve son 120.000 yılda Tuz Gölü'nün seviye/sediman değişimlerini (Buzul çağı pluvial dev göl safhalarından günümüze) simüle eden paleo-iklim modülüdür.
*   **Dunaliella Biyoreaktör & Karbon Yakalama Simülatörü:** Endüstriyel alg reaktörlerindeki CO₂ beslemesi, ışık, besin (N/P) ve sıcaklık girdilerine bağlı fotosentez büyüme kinetiğini, lipid/biyoyakıt verimini ve karbon tutum oranlarını simüle eden biyoteknoloji-enerji modülüdür.
...
### Kuvaterner Paleolimnoloji ve Milankovitch Güneş Işınımı (Insolation) Fiziği

Tuz Gölü, Kuvaterner (Kuvaterner Plüvyal Gölleri) buzul dönemlerinde, düşük sıcaklıklar ve bugünkünün yaklaşık 2-3 katı olan yağış miktarları sayesinde derin bir tatlı/acı su gölüne dönüşmüştür. Havzadaki bu hidrolojik ve paleo-limnolojik salınımlar, Dünya'nın **Milankovitch Döngüleri** ile kontrol edilen güneş ışınımı (insolation) değişimleriyle doğrudan ilişkilidir:

1. **Eksantriklik (Eccentricity - $e$):** Yörüngenin dairesellikten elipsliğe kayması (96.000 ve 413.000 yıllık periyotlar). Mevsimsel ışınım kontrastını ve yalpalamanın etkisini genleştirir.
2. **Eksen Eğikliği (Obliquity / Tilt - $\epsilon$):** Eksen eğikliğinin 22.1° ile 24.5° arasında değişmesi (41.000 yıllık periyot). Yüksek enlemlerdeki yaz insolasyonunu doğrudan belirler ve buharlaşma hızını yönetir.
3. **Yalpalama (Precession - $p$):** Eksenin dönüş yönünün yalpalaması (19.000 - 23.000 yıllık periyotlar). Günberi (perihelion) mevsimini kaydırarak ekstrem yaz/kış sıcaklık anomalilerine yol açar.

Haziran ayı 65°K enlemindeki güneş radyasyonu ($I$), Milankovitch girdilerine bağlı olarak doğrusal olmayan bir modülasyon sergiler ve sıcaklık anomalisi ($\Delta T$) ile göl su bütçesini kontrol eder:

$$\Delta T \propto f(e, \epsilon, p)$$
...
### Dunaliella Biyoreaktör & Fotosentez Karbon Yakalama Kinetiği

Tuz Gölü'nde yaygın bulunan *Dunaliella salina*, endüstriyel algal biyoreaktörlerde karbondioksit ($CO_2$) emilimi ve yüksek verimli lipid/biyoyakıt üretimi için tasarlanmıştır. Büyüme hızı ($\mu$, 1/gün), Monod-kinetiği ve sıcaklık sınırlama faktörlerine bağlı olarak aşağıdaki formülle modellenir:

$$\mu = \mu_{max} \cdot \left(\frac{C_{CO_2}}{K_{CO_2} + C_{CO_2}}\right) \cdot \left(\frac{I_{isik}}{K_{isik} + I_{isik}}\right) \cdot f(T)$$

Burada:
- $\mu_{max}$: Maksimum spesifik büyüme hızı (gün⁻¹)
- $C_{CO_2}$: Beslenen CO₂ derişimi (ppm)
- $I_{isik}$: Güneş ışınım akısı (W/m²)
- $K_{CO_2}, K_{isik}$: Yarı doygunluk sabitleri
- $f(T)$: Sıcaklık sınırlama fonksiyonu (optimum 28°C)

Stres koşullarında (azot/fosfor kısıtlaması, aşırı güneş radyasyonu), alg hücresi büyüme hızını düşürerek enerjisini lipid depolamaya ve beta-karoten sentezine yönlendirir. Bu süreç, karbon tutumunu artırırken biyodizel hammaddesi olan triaçilgliserollerin ($TAG$) ve biyoplastik sentezlenebilecek poli-hidroksialkanoat ($PHA$) öncüllerinin hücre içinde birikmesini sağlar.
...
*   **Tuzlu Bağ Efsanesi (Dervişin Bedduası):** Cimri bir kadının dervişe yalan söyleyip üzüm vermemesi sonucu dervişin bedduasıyla yemyeşil bağların tuz gölüne dönüştüğü anlatılır.
*   **Obruk Hanı ve Kızören Söylenceleri:** Kızören obruğunun oluşumuna dair Hızır söylenceleri ve obruk diplerinden gece yükselen uğultulu yansımalar yerel folklora konu olmuştur.
*   **Manyetik Anomaliler:** Havzada yer alan gabroik ve ultramafik ofiyolitik temeller, yerel manyetik alanda belirgin sapmalara (anomaly) yol açmaktadır.
*   **Fata Morgana (Serap):** Sıcaklık inversiyonu altındaki hava katmanlarında Snell Yasası'na ($\sin\theta_1 \cdot n_1 = \sin\theta_2 \cdot n_2$) göre kırılan ışığın, uzaktaki nesneleri gökyüzünde asılı veya ters dönmüş göstermesidir.

> [!NOTE]
> Bu gizemlerin jeofizik, optik fizik, akustik iletim dalga teorisi ve kültürel antropoloji eksenindeki bol alıntılı detaylı akademik dökümüne [Tuz Gölü Gizemleri Araştırma Raporu](file:///C:/Users/bahat/.gemini/antigravity/brain/0ddd55a9-d8a2-44d4-bb7f-a7f0013471aa/tuz_golu_gizemleri_arastirma.md) dosyasından ulaşabilirsiniz.
